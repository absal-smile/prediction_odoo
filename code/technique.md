...
### Phase 1 : Préparation
- Ajout du nouveau paramètre de configuration `loomis_partner.client_balance_api_base_url`
- Conservation temporaire de l'ancien paramètre `loomis_partner.client_balance_api`
- Développement des nouvelles fonctionnalités REST
...
### Phase 4 : Nettoyage
- Suppression des éléments obsolètes (imports, fonction `_get_client`)
- Mise à jour de la documentation
- Formation des équipes support
...
### Question:
adapter moi cette documentation avec la nouvelle 
# Documentation technique : Migration des APIs SOAP vers REST
